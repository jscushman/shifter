...
class CalendarsControllerTest < ActionController::TestCase
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post :create, calendar: { description: @calendar.description, max_simultaneous: @calendar.max_simultaneous, title: @calendar.title }
    end
  ...
  test "should update calendar" do
    patch :update, id: @calendar, calendar: { description: @calendar.description, max_simultaneous: @calendar.max_simultaneous, title: @calendar.title }
    assert_redirected_to calendar_path(assigns(:calendar))
  end
